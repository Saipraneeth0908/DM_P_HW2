...
def fit_hierarchical_cluster(data,linkage_type,num_of_clusters,random_state):
...
def compute():
    ...
    myplt.plot_part1C(hierarchical_dict_plotting,'Part_4.jpg')
    ...
    myplt.plot_part1C(hierarchical_dict_plotting,'Part_4_C.jpg')    
